...
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/controllers/categories/list.php'); ?>
<?php include_once($_SERVER['DOCUMENT_ROOT'] . '/controllers/categories/delete.php'); ?>
...
<div class="container mt-5 pt-5 h-full-wf">
    ...
    <div class="d-flex justify-content-end gap-2">
        <a href="./create.php" class="btn btn-primary">Crear nueva categoría</a>
    </div>
    ...
    <div class="toast-container position-absolute" style="z-index: 9999; right: 20px; top: 60px">
        ...
        <div class="toast bg-danger text-white" data-delay="3500" role="alert"
            ...
            <div class="toast-body">
                ...
                <strong class="mr-auto">Ocurrió un error al intentar borrar la categoría seleccionada!</strong>
            </div>
        </div>
    </div>
    <div class="toast-container position-absolute" style="z-index: 9999; right: 20px; top: 60px">
